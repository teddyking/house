...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HouseStatus) DeepCopyInto(out *HouseStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HouseStatus.
func (in *HouseStatus) DeepCopy() *HouseStatus {
	if in == nil {
		return nil
	}
	out := new(HouseStatus)
